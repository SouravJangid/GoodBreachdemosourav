  ...
  useEffect(() => {
    const fetchGoals = async () => {
      try {
        ...
        console.log("Fetching goals for user:", response);
        console.log("API Response:", JSON.stringify(response.data.data.data, null, 2));

        if (response?.status === 201 && Array.isArray(response?.data?.data?.data)) {
